...
class XLMRobertaWrapper(PreTrainedModel, BaseTextModel):
    def __init__(self, config: XLMRobertaModel):
        super(XLMRobertaWrapper, self).__init__(config)
    ...
    def forward(self, input_ids: Tensor, attention_mask) -> ModelOutput:
        """
